return {
	...
	misc = {
		...
		dictionary = {
			...
			k_warning_no_order = "Your opponent has The Order integration enabled but you do not. This will cause the seeds to differ. If this is a ranked/tournament match, enable The Order integration at Mods > Multiplayer > Config and then restart",
			k_warning_nemesis_no_order = "You have The Order integration enabled but your opponent does not. This will cause the seeds to differ. If this is a ranked/tournament match, instruct them to enable The Order integration",
			...
			k_attrition_description = "Every boss blind is a Nemesis blind.",
			k_showdown = "Showdown",
			k_showdown_description = "After the first 2 antes, every blind is a Nemesis blind.",
			k_survival = "Survival",
			k_survival_description = "The player who beats the farthest blind wins.",
			k_oops_ex = "Oops!",
			k_timer = "Timer",
