return {
	...
	misc = {
		...
		dictionary = {
			...
			k_sandbox = "Sandbox",
			k_sandbox_description = "steph's sandbox. Experimental ruleset testing wild balance concepts based on high-level player insights. We're allowed to be a little bit silly.",
			k_vanilla = "Vanilla",
