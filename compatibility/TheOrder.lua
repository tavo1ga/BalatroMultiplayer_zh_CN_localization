...
-- Wrapped in a function so different rulesets can override standard pack behavior
-- (e.g., sandbox ruleset excludes glass cards via MP.SANDBOX.standard_pack_ownership())
